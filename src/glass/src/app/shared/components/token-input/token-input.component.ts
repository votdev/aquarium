...
export class TokenInputComponent
  ...
  public controlType = 'token-input';
  public _value = '';
  public _placeholder = '';
  ...
  private _uniqueId = `mat-token-input-${++nextUniqueId}`;
  ...
  private formatValue(value: TokenFormat): string {
    return `${value.segment1}-${value.segment2}-${value.segment3}-${value.segment4}`;
  }
